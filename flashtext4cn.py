# -*- coding: utf-8 -*-
# slightly modified based on flashtext
...
class KeywordProcessor4cn(object):
    """KeywordProcessor
    ...
    def __init__(self, case_sensitive=False):
        ...
        try:
            ...
            # python 3.x  original : self.non_word_boundaries = set(string.digits + string.ascii_letters + '_')
            self.non_word_boundaries = set('_')   # modified
                ...
                if self._keyword in current_dict or char in current_dict:
                    ...
                    if char in current_dict:
                        ...
                        if is_longer_seq_found:
                            idx = sequence_end_pos-1   # modified 
                    current_dict = self.keyword_trie_dict
                    ...
                    if char in current_dict:
                        ...
                        while idy < sentence_len:
                            ...
                            if self._keyword in current_dict_continued:
                                ...
                                is_longer_seq_found = True
                        if is_longer_seq_found:
                            idx = sequence_end_pos    # modified from idx = sequence_end_pos
